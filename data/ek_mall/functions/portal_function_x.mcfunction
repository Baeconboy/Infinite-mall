execute positioned ~ ~1.5 ~ run particle dust 0.110 0.584 1.000 1 ~ ~ ~ 0.3 0.5 0.1 0 50 force
...
execute if dimension ek_mall:ek_mall positioned ~-.5 ~ ~ unless predicate ek_mall:x_portal in minecraft:overworld run forceload remove ~ ~
execute if dimension minecraft:overworld positioned ~-.5 ~ ~ unless predicate ek_mall:x_portal in ek_mall:ek_mall run forceload remove ~ ~
execute positioned ~-.5 ~ ~ unless predicate ek_mall:x_portal run kill @s
